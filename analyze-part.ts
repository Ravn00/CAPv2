...
{"marca":"marca compatible o No determinado","modelo":"modelo o No determinado","años":"rango (ej: 2010-2015) o No determinado","categoria":"parachoques|opticos|focos|guardabarros|capots|varios","descripcion":"descripción breve máx 60 chars","posicion":"Delantero|Trasero|Izquierdo|Derecho|Central|No determinado","confianza":"Alta|Media|Baja","codigo_oem":"código OEM visible o vacío"}`;
